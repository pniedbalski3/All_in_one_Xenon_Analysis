...
analyze_ge_images_stopwiggle(Dis_Image,LoRes_Gas_Image,HiRes_Gas_Image,H1_Image_Dis,Cal_Raw,DisMask,write_path,Dis_Fid,Gas_Fid,Params,Dis_Traj,Gas_Traj)
...
%[status,mean_amps] = newwiggles(Dis_Fid,Gas_Fid,Dis_Traj,Gas_Traj,H1_Image_Dis,LoRes_Gas_Image,Dis_Mask,VentBinMask,RBC_Mask,RBC2Mem,TR,ImSize,scanDateStr,write_path)
%% Clean up
%close all;
%fclose all;