...
clear Vent
%% MALB Ventilation Mask
MALB = double(niftiread(fullfile(mypath,'All_in_One_Analysis','N4_MALB_Ventilation_Labeled_warped.nii.gz')));
ct_tiff_write(CT_Image,MALB,MALBMap,[0.01 3],0.75,'60Pct_Threshold_Ventilation',mypath)
clear MALB
%% LB Ventilation Mask
