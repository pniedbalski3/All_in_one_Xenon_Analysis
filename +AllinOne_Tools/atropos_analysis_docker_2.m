function atropos_analysis_docker_2(Image_Path,Mask_Path)
...
dockercommand = ['docker run ' mapping ' noelmni/antspynet python /mnt/mycode/Analysis_Pipeline/Python_Code/funct_seg_2.py /mnt/mydata/' ImName ' /mnt/mydata/' MskName];
