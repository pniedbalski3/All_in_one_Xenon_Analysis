function imdisplay_allinone_axial(infolder,slice_vent,slice_GE)
...
my_slice_vent = rot90(squeeze(vent(slice_vent,:,:)));
...
figure('Name','Representative Axial Slice of Membrane Image Labeled');
[~,~] = Tools.imoverlay(my_slice_anat,my_slice_meml.*my_slice_mask,[0.01,8],[0,0.99*ProtonMax],gray,1,gca);
colormap(gca,EightBinMap);

figure('Name','Representative Axial Slice of RBC Image Labeled');
