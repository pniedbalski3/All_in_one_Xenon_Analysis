...
%% Write Reports
AllinOne_Tools.write_clin_report(write_path,scanDateStr,HealthyData,VentBins,SumVentFig,RBCBins,SumRBCFig,BarBins,SumRBCBarFig,RBC2BarBins)

AllinOne_Tools.write_full_report(write_path,scanDateStr,HealthyData,VentBins,RBCBins,BarBins,RBC2BarBins,VentBinMontage,VentHistFig,RBCBinMontage,RBCHistFig,BarrierBinMontage,BarHistFig,RBCBarBinMontage,RBCBarHistFig,k0fig,DissolvedNMR,Mask_Fig,Scaled_Vent_tile,GasMontage,DissolvedMontage,RBCMontage,BarrierMontage);
