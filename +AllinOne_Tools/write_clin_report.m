...
Rpttitle = [Seq_Name 'Report_Subject_' Subject];
...
imgStyle = {ScaleToFit(true)};
%Montage Figure
saveas(SumBarrFig,fullfile(path,'All_in_One_Analysis','Analysis_Reports','SumBarrFig.png'));
fig1Img = Image(fullfile(path,'All_in_One_Analysis','Analysis_Reports','SumBarrFig.png'));
fig1Img.Height = H;
fig1Img.Width = '6in';
%Histogram Figure
saveas(BarHistFig,fullfile(path,'All_in_One_Analysis','Analysis_Reports','BarHistFig.png'));
fig2Img = Image(fullfile(path,'All_in_One_Analysis','Analysis_Reports','BarHistFig.png'));
fig2Img.Height = H;
fig2Img.Width = '2in';
%Put in Histogram
row3 = TableRow;
...
imgStyle = {ScaleToFit(true)};
%Montage Figure
saveas(SumRBCBarFig,fullfile(path,'All_in_One_Analysis','Analysis_Reports','SumRBCBarFig.png'));
fig1Img = Image(fullfile(path,'All_in_One_Analysis','Analysis_Reports','SumRBCBarFig.png'));
fig1Img.Height = H;
fig1Img.Width = '6in';
%Histogram Figure
saveas(RBCBarHistFig,fullfile(path,'All_in_One_Analysis','Analysis_Reports','RBCBarHistFig.png'));
fig2Img = Image(fullfile(path,'All_in_One_Analysis','Analysis_Reports','RBCBarHistFig.png'));
fig2Img.Height = H;
fig2Img.Width = '2in';
row4 = TableRow;
...
delete(fullfile(path,'All_in_One_Analysis','Analysis_Reports','SumBarrFig.png'));
delete(fullfile(path,'All_in_One_Analysis','Analysis_Reports','BarHistFig.png'));
delete(fullfile(path,'All_in_One_Analysis','Analysis_Reports','SumRBCBarFig.png'));
delete(fullfile(path,'All_in_One_Analysis','Analysis_Reports','RBCBarHistFig.png'));
