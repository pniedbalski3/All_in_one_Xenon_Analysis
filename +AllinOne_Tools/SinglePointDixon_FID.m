function [shifted_FID, Delta_angle_deg] = SinglePointDixon_FID(DisFID,RbcBarrierRatio,GasFID)
...
Initial_angle_rad=angle(sum(B0CorrectedDisFID(1,:))); %Maybe change to a mean
