function create_full_ventilation_report(path,workspace_file)
...
if ~isfolder(fullfile(path,'Shareable_Figs'))
    mkdir(fullfile(path,'Shareable_Figs'))
end
saveas(Vent_Overlay_Fig,fullfile(path,'Shareable_Figs','Ventilation_Image.jpg'));
